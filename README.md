...
Una opción habría sido subir el .ova al repositorio directamente, de no ser por su gran tamaño y las limitaciones de GitHub. Sin embargo, si es posible acceder a este mismo archivo desde un enlace a Internet Archive xxxxxxxxxxxxxxxxxxxxxxx.
